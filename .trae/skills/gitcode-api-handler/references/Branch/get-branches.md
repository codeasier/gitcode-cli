...
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-branches
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/branches?access_token=YOUR_TOKEN" \
