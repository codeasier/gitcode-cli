...
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-commits
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/commits?access_token=YOUR_TOKEN" \
...
url = "https://api.gitcode.com/api/v5/repos/owner/repo/commits"
params = {
}
