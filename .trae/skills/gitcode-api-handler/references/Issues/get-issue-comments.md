...
获取指定仓库中某个 Issue 的所有评论列表

## 基本信息

- **方法**: GET
- **路径**: `/repos/:owner/:repo/issues/:number/comments`
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-issues-number-comments
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/issues/:number/comments?access_token=YOUR_TOKEN&per_page=20" \
