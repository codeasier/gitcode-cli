...
- **方法**: GET
- **路径**: `/repos/:owner/:repo/pulls/:number/files.json`
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-pulls-number-files-json
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/pulls/:number/files.json?access_token=YOUR_TOKEN" \
...
url = "https://api.gitcode.com/api/v5/repos/:owner/:repo/pulls/:number/files.json"
