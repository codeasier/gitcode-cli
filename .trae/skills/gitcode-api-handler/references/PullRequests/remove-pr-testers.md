...
- **文档URL**: https://docs.gitcode.com/docs/apis/delete-api-v-5-repos-owner-repo-pulls-number-testers
...
```bash
curl -X DELETE "https://api.gitcode.com/api/v5/repos/:owner/:repo/pulls/:number/testers?access_token=YOUR_TOKEN" \
