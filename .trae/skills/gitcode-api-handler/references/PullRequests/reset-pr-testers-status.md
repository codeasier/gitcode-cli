...
- **文档URL**: https://docs.gitcode.com/docs/apis/patch-api-v-5-repos-owner-repo-pulls-number-testers
...
| 参数名 | 类型 | 必填 | 描述 |
|--------|------|------|------|
| reset_all | boolean | 否 | 是否重置所有测试状态 |
...
```bash
curl -X PATCH "https://api.gitcode.com/api/v5/repos/:owner/:repo/pulls/:number/testers?access_token=YOUR_TOKEN" \
