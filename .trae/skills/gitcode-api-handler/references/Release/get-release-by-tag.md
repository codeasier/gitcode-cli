...
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-releases-tag
...
| temp_download_url | boolean | 否 | 是否返回源码包和附件临时下载地址，默认false |
...
| └─ temp_download_url | string | 临时下载地址(当temp_download_url=true时返回) |
  ...
  "assets": [
    {
      ...
      "temp_download_url": "https://gitcode.com/temp-download/abc123"
    }
  ]
}
```
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/releases/:tag?access_token=YOUR_TOKEN&temp_download_url=true" \
