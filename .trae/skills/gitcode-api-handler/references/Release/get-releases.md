...
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-releases
...
[
  ...
  },
  {
    ...
    "created_at": "2024-01-10T08:20:00.000+08:00",
    "assets": []
  }
]
```
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/releases?access_token=YOUR_TOKEN&page=1&per_page=20" \
