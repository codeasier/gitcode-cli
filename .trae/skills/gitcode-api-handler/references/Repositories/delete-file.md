...
- **文档URL**: https://docs.gitcode.com/docs/apis/delete-api-v-5-repos-owner-repo-contents-path
...
```bash
curl -X DELETE "https://api.gitcode.com/api/v5/repos/:owner/:repo/contents/:path?access_token=YOUR_TOKEN" \
...
```json
{
  "content": null,
  "commit": {
    "sha": "delete123abc456def123abc456def123abc4",
    "html_url": "https://gitcode.com/owner/repo/commit/delete123",
    "author": {
      "name": "John Doe",
    ...
    "message": "Delete file",
    "tree": {
      "sha": "tree123abc456def123abc456def123abc4",
      "url": "https://api.gitcode.com/api/v5/repos/owner/repo/git/trees/tree123"
    },
    "parents": [
      {
        "sha": "parent123abc456def123abc456def123abc",
