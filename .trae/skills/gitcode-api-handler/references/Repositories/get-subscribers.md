...
获取 watch(关注)了指定仓库的用户列表。

## 基本信息

- **方法**: GET
- **路径**: `/repos/:owner/:repo/subscribers`
- **文档URL**: https://docs.gitcode.com/docs/apis/get-api-v-5-repos-owner-repo-subscribers
...
```bash
curl -X GET "https://api.gitcode.com/api/v5/repos/:owner/:repo/subscribers?access_token=YOUR_TOKEN&per_page=10"
```
