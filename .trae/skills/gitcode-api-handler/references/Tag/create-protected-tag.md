...
- **文档URL**: https://docs.gitcode.com/docs/apis/post-api-v-5-repos-owner-repo-protected-tags
...
| create_access_level | integer | 否 | 允许创建的访问级别，默认40 |
...
```bash
curl -X POST "https://api.gitcode.com/api/v5/repos/:owner/:repo/protected_tags?access_token=YOUR_TOKEN" \
